  ...
  <section class="py-20 bg-white" id="comparativo">
    <div class="max-w-4xl mx-auto px-6" data-fade>
      ...
      <div class="text-center mt-8">
        <RouterLink to="/app/dashboard" class="btn btn-lg rounded-full px-10 font-bold text-white bg-brand">
          Começar agora
        </RouterLink>
      </div>
    </div>
...
<script setup>
const rows = [
  { item: 'Certificado digital e-CPF',       mercado: 'R$ 120–200', caronte: 'Custo Zero', highlight: false },
  { item: 'Consultoria e documentação',       mercado: 'R$ 500–600', caronte: 'Custo Zero', highlight: false },
  { item: 'Taxas governamentais de abertura', mercado: 'R$ 70–150',  caronte: 'Custo Zero', highlight: false },
  { item: 'Economia total estimada',          mercado: 'Até R$ 950', caronte: 'Até R$ 4.000', highlight: true },
];
</script>
