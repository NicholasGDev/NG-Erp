  ...
  <section class="bg-gray-50 border-y border-base-200 py-5">
    <div class="max-w-7xl mx-auto px-6 flex flex-wrap items-center justify-center gap-8" data-fade>
      ...
      <div class="flex items-center gap-2 text-sm font-medium text-gray-600">
        <span class="w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-black bg-brand">★</span>
      ...
      <div class="flex items-center gap-2 text-sm font-medium text-gray-600">
        ...
        <span>Desde 2026 — em constante evolução</span>
      </div>
