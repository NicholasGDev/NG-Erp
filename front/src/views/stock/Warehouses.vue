<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      <h2 class="text-xl font-black text-base-content">Armazéns</h2>
    ...
    <DrawerPanel v-model="drawerOpen" :title="form.id ? 'Editar Armazém' : 'Novo Armazém'">
      <div class="space-y-4">
        <fieldset class="fieldset">
          ...
          <input v-model="form.name" type="text" placeholder="Ex: Depósito Central" class="input border border-base-300 w-full" />
        </fieldset>
        <fieldset class="fieldset">
          <legend class="fieldset-legend">Tipo</legend>
          <select v-model="form.type" class="select border border-base-300 w-full">
        ...
        <fieldset class="fieldset">
          ...
          <textarea v-model="form.address" class="textarea border border-base-300 w-full" rows="3" placeholder="Opcional" />
        </fieldset>
